...
describe("txtLinkToArray", () => {
  describe("Test the positivie scenarios", () => {
    ...
    it("tests correct txt sitemap input, with 1 incorrect link", async () => {
      //@ts-ignore
      global.fetch = jest.fn(() =>
        Promise.resolve({
          text: () =>
            Promise.resolve(
              "https://coh3stats.com/\nhttps://coh3stats.com/about\nhtps://coh3stats.com/about\nhttps://coh3stats.com/leaderboards?race=american&type=1v1\n",
            ),
        }),
      );
...
describe("parseSiteMap", () => {
  ...
  describe("positive scenarios", () => {
    it("tests correct input with 3 sub sitemaps", async () => {
      //@ts-ignore
      global.fetch = jest.fn((url: string) => {
        switch (url) {
          case "https://www.profiq.com/wp-sitemap.xml": {
      ...
      const siteObject = {
        ...
        sitemapindex: {
          sitemap: [
            {
              loc: "https://www.profiq.com/wp-sitemap-posts-post-1.xml",
            },
            {
              loc: "https://www.profiq.com/wp-sitemap-posts-page-1.xml",
            },
            {
              loc: "https://www.profiq.com/wp-sitemap-posts-job-1.xml",
            },
          ],
        },
      };

      expect(parsedSitemapObject).toEqual(siteObject);
    });
  });
  describe("negative scenario", () => {
    it("tests bad xml format input", async () => {
      //@ts-ignore
      global.fetch = jest.fn(() =>
        Promise.resolve({
          text: () =>
            Promise.resolve(
              '<?xmal version="1.0" encoding="UTF-8"?><?xml-stylesheet type="text/xsl" href="https://www.profiq.com/wp-sitemap.xsl" ?><xrlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"><url><loc>https://www.profiq.com/job/fullstack-developer-react-node-js-ostrava/</loc></url><url><loc>https://www.profiq.com/job/backend-developer-elixir-virtual-payment-platform/</loc></url><url><loc>https://www.profiq.com/job/junior-developer/</loc></url><url><loc>https://www.profiq.com/job/junior-software-engineer-in-qa/</loc></url><url><loc>https://www.profiq.com/job/javascript-platform-developer/</loc></url></urlset>',
            ),
        }),
      );
      const parsed = await _parseSitemap("");
      expect(logger.log).toBeCalledWith(
        "error",
        "xml doesnt have property sitemapindex or urlset (unsupported format)",
      );
